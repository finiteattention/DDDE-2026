...
The Norwegian Labour and Welfare Administration (Nav) handles a lot of information about citizens. Like any public body, Nav must comply with many different regulations about the processing of personal information, GDPR being just one example. Previously, Nav developed a digital self-assessment tool to help colleagues work through Nav's "success criteria" for compliance with a range of different regulations. The tool models the legislative material in a highly structured way, with requirements descriptions and success criteria being owned and kept updated in the tool by subject specialist "requirements owners".

Where processing of citizens' data poses potential risk to their privacy rights, teams may also need to complete a Data Protection Impact Assessment (DPIA). DPIA involves identifying and estimating risks, then implementing measures to reduce the level of risk. In contrast to Nav's mature tool for documenting compliance with general regulations, until recently, DPIA in Nav was documented, reviewed and signed off using a Microsoft Word template. Word as a format was challenging for those doing the documenting, many of whom were not familiar with DPIA or privacy legislation. It was also not without problems for Nav's data privacy ombudsman, who reviews DPIAs and returns them with feedback, and for risk owners in the organisation who need an up to date overview of their risk portfolio. When talking to these user groups, the word we heard most often was "uoversiktlig", a Norwegian word that means, roughly, "impossible to get an overview of". 
...
* Practical design considerations when allowing users to complete their regular compliance documentation and their DPIA side by side. 
...
I've uploaded a couple of annotated screengrabs and a concept sketch to a GitHub repo for this submission, to give an idea of what the tool looks like and show just some of the design considerations that went into it. Of course when I present, I wouldn't show the annotations, but talk through the ideas instead. 

* DPIA overview screen: https://github.com/finiteattention/DDDE-2026/blob/3e72cb953676e1b2c10a6e966f9aa837060cdfe3/DPIA%20overview%20page%20DDDE.pdf

* DPIA and regular compliance requirement screen: https://github.com/finiteattention/DDDE-2026/blob/3e72cb953676e1b2c10a6e966f9aa837060cdfe3/Requirement%20page%20DDDE.pdf

* Concept sketch: https://github.com/finiteattention/DDDE-2026/blob/3e72cb953676e1b2c10a6e966f9aa837060cdfe3/Concept%20sketch%20DDDE.pdf
