...
The Norwegian Labour and Welfare Administration (Nav) handles a lot of information about citizens. Like any public body, Nav must comply with many different regulations about processing of personal information, GDPR being just one example. Of course, it's unreasonable to expect software development teams, facilities management, benefits offices etc, to each have the expertise required to understand and document compliance with many different laws, and to keep up with legislative changes. Previous work at Nav has developed a digital self-assessment tool to help individuals or teams work through Nav's "success criteria" for compliance with a range of different legislations. The tool models the legislative material in a highly structured way, with requirements descriptions and success criteria being owned and kept updated in the tool by subject specialist "requirements owners".
